    ...
    return(
        <Styled.Container>
            ...
            <Styled.ContentContainer>
                <Styled.SectionTitle>Compartilhe suas ideias ou dúvidas com os autores!</Styled.SectionTitle>
                ...
                <Styled.Button><FontAwesomeIcon icon={faAdd} inverse className='faIcon'/>criar tópico</Styled.Button>
            </Styled.ContentContainer>
        </Styled.Container>
    )
}
